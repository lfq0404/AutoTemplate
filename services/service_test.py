...
if __name__ == '__main__':
    ...
    # 一句话中多个选项，考虑拆分，而不嵌套
    text = '''双侧腋窝及锁骨上未及异常肿大淋巴结'''
    text = '口咽 有/无 活动性/陈旧性 出血'
    # 已经把选项分别展示出来了，怎么处理
    text = '''眼压：右：[0] 左：[0] mmHg'''
    # 有些是应该为绿色，有些否应该为绿色
    text = '''2、拔管情况：导管是否完整：是/否 。拔管过程 拔管过程  '''
    # 第一层级有输入 + 选项
    text = '粪便隐血试验(输入)：阴性/阳性'
    text = '意识清，接触合作，问答切题，未引出明显幻觉及妄想。可查及情绪低落、自我评价低、消极、兴趣减退、精力不振等抑郁症状及易紧张、过分担忧、多思多虑、躯体不适等焦虑症状。查及密闭恐惧及社交恐惧等症状 '
    # type_name = '其他'
    ...
    # text = '单侧/双侧对光反射是否灵敏'
    text = '患儿时间前有/无诱因下出现发热，体温最高[0]℃，伴部位肿块，伴/不伴触痛，有/无咳嗽，有/无头痛头晕，有/无呕吐，有/无腹泻，有/无皮疹。目前治疗情况'
